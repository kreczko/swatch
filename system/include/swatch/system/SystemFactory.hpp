...
template<> bool swatch::core::ClassRegistrationHelper2g<swatch::system::System, classname >::initialised_= \
  swatch::core::ClassRegistrationHelper2g<swatch::system::System, classname >::init(#classname);

#define SWATCH_SYSTEM_REGISTER_CREATOR( creatorname ) \
template<> bool swatch::core::CreatorRegistrationHelper2g< swatch::system::System, creatorname >::initialised_= \
  swatch::core::CreatorRegistrationHelper2g< swatch::system::System, creatorname >::init(#creatorname);
