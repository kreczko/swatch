...
AMC13Service::AMC13Service(const std::string& aId, const core::Arguments& aArguments) : Service(aId, aArguments) {
    slot_ = aArguments.get<int>("slot",13);
    crateId_ = aArguments.get<std::string>("crate","");
}
